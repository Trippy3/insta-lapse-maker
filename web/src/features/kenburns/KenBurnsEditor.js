...
export function KenBurnsEditor({ clip }) {
    ...
    return (_jsxs("div", { className: "kb-editor", children: [_jsxs("div", { className: "row", style: { justifyContent: "space-between" }, children: [_jsx("div", { className: "row", children: !kb ? (_jsx("button", { className: "primary", onClick: enable, children: "Ken Burns \u3092\u6709\u52B9\u5316" })) : (_jsxs(_Fragment, { children: [_jsx("label", { style: { fontSize: 11, color: "var(--text-dim)" }, children: "\u30A4\u30FC\u30B8\u30F3\u30B0" }), _jsxs("select", { value: easing, onChange: (e) => update({ easing: e.target.value }), children: [_jsx("option", { value: "linear", children: "linear" }), _jsx("option", { value: "ease_in_out", children: "ease_in_out" })] })] })) }), kb && (_jsx("button", { onClick: disable, children: "Ken Burns \u89E3\u9664" }))] }), kb && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "kb-legend", children: [_jsx("span", { className: "kb-dot kb-dot-start" }), " \u958B\u59CB", _jsx("span", { className: "kb-dot kb-dot-end" }), " \u7D42\u4E86", _jsx("span", { style: { marginLeft: "auto", color: "var(--text-dim)" }, children: "\u77E9\u5F62\u30AF\u30EA\u30C3\u30AF\u3067\u9078\u629E \u2192 \u672C\u4F53\u30C9\u30E9\u30C3\u30B0\u3067\u79FB\u52D5 / \u56DB\u9685\u3067\u62E1\u7E2E" })] }), _jsx("div", { className: "kb-stage-wrap", children: _jsx(Stage, { width: STAGE_W, height: STAGE_H, onMouseDown: (e) => {
                                // 背景クリックで選択解除
